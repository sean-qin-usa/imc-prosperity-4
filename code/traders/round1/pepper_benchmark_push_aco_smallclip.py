"""Benchmark-push variant that only shrinks ACO execution clips.

Use this to isolate whether lower overall average fill can come mainly from
ASH_COATED_OSMIUM sizing while preserving the stronger PEPPER benchmark-push
carry leg.
"""
...
class Trader(_BASE_MODULE.Trader):
    ...
    def trade_aco_mean_reversion(self, order_depth, position):
        orders = []
