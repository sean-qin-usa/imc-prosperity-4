"""Official-site PEPPER follow-up with later exit only.

This keeps the successful 135381 follow-up entry logic intact and changes only
the exit timing:
- remove the 90k soft-reduction
- delay flattening to the final 1k timestamps

Use this as the next official upload if the goal is to preserve the proven
entry behavior while testing whether the 135381 exits still leave money behind.
"""
