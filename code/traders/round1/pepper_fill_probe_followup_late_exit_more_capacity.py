"""Official-site PEPPER follow-up with later exit and higher late capacity.

This is a controlled variant of `pepper_fill_probe_followup_late_exit.py`.
Only the late-phase target inventory is increased so we can test whether the
best probe is still target-capped after 30k.
"""
