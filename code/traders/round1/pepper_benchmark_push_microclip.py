"""Benchmark-push variant with aggressively smaller clips.

This pushes farther toward the low-average-fill leaderboard profile by cutting
both passive and aggressive clip sizes. It is intentionally more conservative
than `pepper_benchmark_push_smallclip.py`.
"""
...
class Trader:
    ...
    IPR_LATE_BAND_QTY = 1
    IPR_PASSIVE_BID_SIZE = 5
    IPR_EARLY_TAKE_WINDOW = 500
    IPR_EARLY_TAKE_CLIP = 6
    IPR_VAR_ALPHA = 0.06
