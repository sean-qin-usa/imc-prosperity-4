"""Official-site PEPPER follow-up with later exit and +2-only quoting.

Locked snapshot of the current best PEPPER-only official probe after bundle
135850. This preserves the clean A/B winner where removing the +3 quote
improved entry price without reducing the fill pattern.
"""
