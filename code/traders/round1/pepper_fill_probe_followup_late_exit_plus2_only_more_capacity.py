"""Official-site PEPPER follow-up with later exit, +2-only quoting, and higher late capacity.

This is the next controlled step after the 135850 winner:
- keep the winning +2-only entry logic
- keep the winning 99k flatten
- increase only the final two target inventories from 12 to 16
"""
