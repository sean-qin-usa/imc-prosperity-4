"""
Round 3 combined SHIP v2 — 2026-04-25 (session 3).

ONE-LINE DELTA vs ship_v1: combined = ema_o_dev + 2.25 * iv_dev
(was ema_o_dev + 1.0 * iv_dev). Up-weights the per-strike IV residual,
which carries more predictive power per unit than the underlying-EMA
deviation. Same threshold (5), same window (30), same strikes
{5000-5300}, same HYDROGEL/synth-MM/VFE-MR sleeves.
