...
class Trader:
    ...
    # Drift-regime gate (added 2026-04-25, see h_day1_drift_v2.py).
    # Stand-alone HYDROGEL backtest: 181,675 → 183,461 (+1,786, all 3 days
    # improved). Cliffs: R<=51 = -28k day 2; B>=1.7 = -95 day 1.
    MID_RANGE_HISTORY = 200
    DRIFT_GATE_RANGE = 53
    DRIFT_CLIP_BOOST = 1.6
