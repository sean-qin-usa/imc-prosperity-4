"""
Round 3 combined SHIP v28 — 2026-04-25 (session 9 close).
...
3-day match-trades all (PYTHONHASHSEED=0): 154,592 / 179,378 / 185,709
                                                              = 519,679

Per-product vs shipped v27:
  HYDROGEL_PACK         v28 193,793   v27 188,720   diff +5,073
  VELVETFRUIT_EXTRACT   v28 110,684   v27 110,162   diff   +522
  VEV strikes (4000-5500)         identical (no change)

(The HYDROGEL delta is from order-resolution timing: with shorter
warmup, VFE Citadel orders submit on more ticks of day-0, freeing
HYDROGEL's matcher slot earlier on shared-tick contests.)

Live forecast: ~550k assuming 1.06x bt-to-live conversion per
`feedback_citadel_overconverts_live`.
