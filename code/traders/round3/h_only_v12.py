...
class Trader:
    ...
    # v12: cap make-quote on adding side at extreme position (no take changes).
    H_NO_ADD_POS = 180
    ...
    def _trade_hydrogel(self, od, pos, last_dmid, dmid_hist):
        ...
        # v12: refuse to ADD more inventory when at extreme position.
        if working >= self.H_NO_ADD_POS:
            bid_size = 0
        if working <= -self.H_NO_ADD_POS:
            ask_size = 0
