...
class Trader:
    ...
    # v17 retune (vol-adaptive post size new vs v16):
    H_ANCHOR = 9983.0
    H_CLIP = 33.0
    H_TAKE_EDGE = 0.5
    H_REDUCE_EDGE = 0.0    # MUST stay 0 with TE=0.5
    H_PENNY_EDGE = 3.0
    H_INV_SKEW = 0.014
    H_MAX_POST_SIZE = 18   # legacy; kept for backwards-compat refs (unused)
    ...
    # v17: vol-adaptive max post size. adaptive = clip(BASE - K*std, [MIN, MAX]).
    # Plateau 0.95-1.00; cliff at 1.05+. Plateau MIN: doesn't bind in practice.
    H_BASE_POST_SIZE = 18
    H_POST_VOL_K = 1.0
    H_POST_MIN = 12
    H_POST_MAX = 18
