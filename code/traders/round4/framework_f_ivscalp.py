...
# Framework F: lowered THR_OPEN from 0.5 → 0.03 (timo_clone_FINAL R4 retune).
# Lowered IV_SCALPING_THR from 0.7 → 0.0 (effectively disabled; timo_clone said
# it's dead at our residual scale ~0.4 vs his ~0.7).
THR_OPEN, THR_CLOSE = 0.03, 0.0
...
SCALP_STRIKES: Dict[str, int] = {"VEV_5000": 5000, "VEV_5100": 5100}
MR_STRIKES = {
