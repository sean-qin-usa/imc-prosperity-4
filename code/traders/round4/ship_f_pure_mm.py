...
# Ship F: MR sleeve disabled (directional voucher MR — too volatile)
MR_STRIKES: Dict[str, int] = {}
...
class Trader:
    ...
    # ----- Ship F: Citadel DISABLED (directional bet, only pays in z-extreme regime) -----
    ENABLE_CITADEL_VFE_MR = False
    ...
    # ----- VFE drift carry DISABLED in Ship F (no directional long bias) -----
    UNDER_DRIFT_TARGET = 0
    VEV_CARRY_TARGET = 0
    VEV_CARRY_SIZE = 0
    UNDER_CARRY_BID_SIZE = 0

    # ----- Ship F: V5000-V5300 also use smile-EMA MM (pure spread capture) -----
    ATM_STRIKES = {
