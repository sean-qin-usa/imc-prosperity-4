...
class Trader:
    ...
    # Counterparty overlay: use Marks as VFE vetoes, not as a replacement
    # alpha. Mark 67 buys and Mark 49 sells both predict a bullish post-fill
    # mid move; Mark 49 buys are the small bearish fade case.
    ENABLE_MARK_VFE_DEFENSE = True
    MARK_VFE_COOLDOWN_TS = 2000
