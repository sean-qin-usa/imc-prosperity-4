"""Round 2 aggressive ACO backtester-optimized variant.
...
This experiment keeps the baseline fair model but posts the full ACO cap using
1-lot child orders, which strongly exploits the local matcher.
