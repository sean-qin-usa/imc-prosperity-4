...
| 5 | [`round_5__final_strategy.py`](./round_5__final_strategy.py) | [`round_5.md`](../round_5.md) | Directional final ship. The basket-MM variant `ll_pair_base_561965` was run live during R5 and accumulated **$561,965 cumulative live** — not the file selected as final ship; see [lessons §0d](../lessons_learned.md) | News Trading: `Lava cake −27 / Ashes −19 / Obsidian −14 / Thermalite +14 / Pyroflex −13 / Magma +8 / Sulfur +5` ([analysis](../code/analysis/round5/manual/README.md)) |
