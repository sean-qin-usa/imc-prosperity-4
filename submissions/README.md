...
| 5 | [`round_5__final_strategy.py`](./round_5__final_strategy.py) | [`round_5.md`](../round_5.md) | Directional ship. The basket-MM variant `ll_pair_base_561965` (not shipped) would have scored **$561,965** per IMC's official-bundle replay — see [lessons §0d](../lessons_learned.md) on shipping the structurally correct version | News Trading: `Lava cake −27 / Ashes −19 / Obsidian −14 / Thermalite +14 / Pyroflex −13 / Magma +8 / Sulfur +5` ([analysis](../code/analysis/round5/manual/README.md)) |
